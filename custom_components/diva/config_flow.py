    ...
    return {
        **profile,
        ...
        MEDICAL_SECTION: {
            ...
            CONF_REGIONAL_POLICY: pet.get(
                CONF_REGIONAL_POLICY,
                pet.get(CONF_MEDICAL_REGION, DEFAULT_MEDICAL_REGION),
            ),
            CONF_VACCINE_PROFILE: pet.get(CONF_VACCINE_PROFILE, VACCINE_PROFILE_OPTIONS[0]),
            CONF_VET_OVERRIDE: pet.get(CONF_VET_OVERRIDE, True),
            ...
            CONF_DIAGNOSES: pet.get(CONF_DIAGNOSES, []),
            CONF_ALLERGIES: pet.get(CONF_ALLERGIES, []),
            CONF_CONTRAINDICATIONS: pet.get(CONF_CONTRAINDICATIONS, []),
            CONF_MEDICAL_HISTORY: pet.get(CONF_MEDICAL_HISTORY, []),
